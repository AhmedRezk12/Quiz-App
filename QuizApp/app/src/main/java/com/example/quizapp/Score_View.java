...
public class Score_View extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score__view);
        ...
        Score.setText(extras.getString("Correct_answers") + " / 7");
    }

    public void AppExit(View view) {
        Intent intent = new Intent(Score_View.this , MainActivity.class);
